 ...
 * Worker running `worker.ts`, sends `StorageAdapter` method
...
import type { StorageRequest, StorageResponse } from "@/browser/sqlite/worker";
...
export interface SqliteOptions {
   ...
   * ```
   *
   * In production (built package), it defaults to `./worker.js`
