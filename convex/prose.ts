...
function createEmptyProseContent(): ProseContent {
  return { type: "doc", content: [{ type: "paragraph" }] };
}

function normalizeProseContent(value: unknown): ProseContent {
  if (
    value &&
    typeof value === "object" &&
...
function proseContentToPlainText(value: unknown): string {
