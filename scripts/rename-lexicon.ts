...
const FAMILIES: ReadonlyArray<RenameFamily> = [
  ...
  {
    id: 9,
    name: "resolve → pull (subsystem) + resolve* verb removed",
    renames: [
      ["ResolveArgs", "PullArgs"],
      ["ResolveAttachment", "PullAttachment"],
      ["ResolveDocument", "PullDocument"],
      ["ResolveDocumentRequest", "PullDocumentRequest"],
      ["ResolveDocumentResponse", "PullDocumentResponse"],
      ["ResolveEntry", "PullEntry"],
      ["ResolveInput", "PullInput"],
      ["ResolveMetadata", "PullMetadata"],
      ["ResolveProgress", "PullProgress"],
      ["ResolveRequest", "PullRequest"],
      ["ResolveResponse", "PullResponse"],
      ["ResolveResultRow", "PullResultRow"],
      ["ResolveType", "PullType"],
      ["resolveAll", "pullAll"],
      ["resolveAllImpl", "pullAllImpl"],
      ["resolveAttachment", "pullAttachment"],
      ["resolveNow", "pullNow"],
      ["resolveDocuments", "pullDocuments"],
      ["resolveEntries", "pullEntries"],
      ["resolveResult", "pullResult"],
      ["resolveInFlight", "pullInFlight"],
      ["resolveDiscovery", "pullDiscovery"],
      ["resolveServices", "pullServices"],
      ["resolveDirtyCrdtRows", "mergeDirtyCrdtRows"],
      ["resolveDirtyCrdtRowsImpl", "mergeDirtyCrdtRowsImpl"],
      ["resolveDirtyRowsForTable", "mergeDirtyRowsForTable"],
      ["resolveFunction", "getFunction"],
      ["resolveFunctionPath", "getFunctionPath"],
      ["resolveInternalSpec", "getInternalSpec"],
      ["resolveEmbeddedTableName", "getEmbeddedTableName"],
      ["resolveEmbeddedBrowserClient", "getEmbeddedBrowserClient"],
      ["resolveTable", "getTableSpec"],
      ["resolveTableForWrite", "getTableForWrite"],
      ["resolveTablePaginated", "getTablePagePlan"],
      ["resolveSearchIndexDefinition", "getSearchIndexDefinition"],
      ["resolveVectorIndexDefinition", "getVectorIndexDefinition"],
      ["resolveQuery", "planQuery"],
      ["resolveMutationRoute", "routeMutation"],
      ["resolveReadRoute", "routeRead"],
      ["resolveMutationPlan", "planMutation"],
      ["resolveReadPlan", "planRead"],
      ["resolveReadPlanByName", "planReadByName"],
      ["resolveCronAtom", "getCronAtom"],
      ["resolveCronJobDefinition", "getCronJobDefinition"],
      ["resolveRangeDocIds", "getRangeDocIds"],
      ["resolveScopedDocIds", "getScopedDocIds"],
      ["resolveRegister", "getRegister"],
      ["resolveRegisterValue", "getRegisterValue"],
      ["resolveSourceFile", "getSourceFile"],
      ["resolveOpfsDirectory", "getOpfsDirectory"],
    ],
  },
];
